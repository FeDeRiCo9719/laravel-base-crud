<header>
    ...
    <a class="navbar-brand" href="{{route('home')}}"><strong>Comics Laravel</strong></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="{{route('comics.index')}}">Comics Series<span class="sr-only">(current)</span></a>
            </li>
            <!-- <li class="nav-item">
